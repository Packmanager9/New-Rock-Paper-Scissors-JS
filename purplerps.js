...
//         console.log(gamepadAPI.axesStatus[1]*gamepadAPI.axesStatus[0]) //debugging
    ...
    class Agent{
        constructor(t, k){
            ...
            this.x = t
            this.y = k
            // this.colors = ['black', 'red', "blue", "#4400FF", "#6600FF", "#FF00FF", "#8800FF", "#AA00FF"]
            this.colors = []
            // this.colors = ['black', "#FFFFFF", "#E21DFF", "#C63AFF", "#AA58FF", "#8884FF", "#58AAFF", "#3AC6FF", "#FFFFFF", "#FFFFFF"]
            for(let t = 0;t<10;t++){
                let r = t*(256/9)
                let g =  0
                let b =( t*(128/9))+128
            ...
            // if(t == Math.floor(canvas.width*.25)){
            //     if(k == Math.floor(canvas.width*.25)){
            //         this.type = 1
            //     }
            // }
            // if(t == Math.floor(canvas.width*.5)){
            //     if(k == Math.floor(canvas.width*.25)){
            //         this.type = 2
            //     }
            // }
            // if(t == Math.floor(canvas.width*.75)){
            //     if(k == Math.floor(canvas.width*.25)){
            //         this.type = 3
            //     }
            // }
            // if(t == Math.floor(canvas.width*.25)){
            //     if(k == Math.floor(canvas.width*.5)){
            //         this.type = 7
            //     }
            // }
            // if(t == Math.floor(canvas.width*.5)){
            ...
            // }
            // if(t == Math.floor(canvas.width*.5)){
            //     if(k == Math.floor(canvas.width*.75)){
            //         this.type = 4
            //     }
            // }
            // if(t == Math.floor(canvas.width*.5)){
            //     if(k == Math.floor(canvas.width*.3)){
            //         this.type = 8
            //     }
            // }
            // if(t == Math.floor(canvas.width*.3)){
            //     if(k == Math.floor(canvas.width*.75)){
            //         this.type = 9
            //     }
            // }
        ...
        attack(spot){
            ...
            if(spot.type == 0){
                spot.type = this.type
                canvas_context.fillStyle = this.colors[this.type]
                canvas_context.fillRect(spot.x, spot.y, 1, 1)
            }
            ...
            if(spot.type == 1 && (this.type == 2 || this.type == 3 || this.type == 4)){
                spot.type = this.type
                canvas_context.fillStyle = this.colors[this.type]
                canvas_context.fillRect(spot.x, spot.y, 1, 1)
            }
            if(spot.type == 2 && (this.type == 3 || this.type == 4 || this.type == 5)){
                spot.type = this.type
                canvas_context.fillStyle = this.colors[this.type]
                canvas_context.fillRect(spot.x, spot.y, 1, 1)
            }
            if(spot.type == 3 && (this.type == 4 || this.type == 5 || this.type == 6)){
                spot.type = this.type
                canvas_context.fillStyle = this.colors[this.type]
                canvas_context.fillRect(spot.x, spot.y, 1, 1)
            }
            if(spot.type == 4 && (this.type == 5 || this.type == 6 || this.type == 7)){
                spot.type = this.type
                canvas_context.fillStyle = this.colors[this.type]
                canvas_context.fillRect(spot.x, spot.y, 1, 1)
            }
            if(spot.type == 5 && (this.type == 6 || this.type == 7 || this.type == 1)){
                spot.type = this.type
                canvas_context.fillStyle = this.colors[this.type]
                canvas_context.fillRect(spot.x, spot.y, 1, 1)
            }
            if(spot.type == 6 && (this.type == 7 || this.type == 1 || this.type == 2)){
                spot.type = this.type
                canvas_context.fillStyle = this.colors[this.type]
                canvas_context.fillRect(spot.x, spot.y, 1, 1)
            }
            if(spot.type == 7 && (this.type == 1 || this.type == 2 || this.type == 3)){
                spot.type = this.type
                canvas_context.fillStyle = this.colors[this.type]
                canvas_context.fillRect(spot.x, spot.y, 1, 1)
            }
            ...
            // if(spot.type == 1 && (this.type == 2 || this.type == 3 || this.type == 4 || this.type == 5)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
            // if(spot.type == 2 && (this.type == 3 || this.type == 4 || this.type == 5 || this.type == 6)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
            // if(spot.type == 3 && (this.type == 4 || this.type == 5 || this.type == 6 || this.type == 7)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
            // if(spot.type == 4 && (this.type == 5 || this.type == 6 || this.type == 7 || this.type == 8)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
            // if(spot.type == 5 && (this.type == 6 || this.type == 7 || this.type == 8 || this.type == 9)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
            // if(spot.type == 6 && (this.type == 7 || this.type == 8 || this.type == 9 || this.type == 1)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
            // if(spot.type == 7 && (this.type == 8 || this.type == 9 || this.type == 1 || this.type == 2)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
            // if(spot.type == 8 && (this.type == 9 || this.type == 1 || this.type == 2 || this.type == 3)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
            // if(spot.type == 9 && (this.type == 1 || this.type == 2 || this.type == 3 || this.type == 5)){
            //     spot.type = this.type
            //     canvas_context.fillStyle = this.colors[this.type]
            //     canvas_context.fillRect(spot.x, spot.y, 1, 1)
            // }
        ...
        draw(){
            if(this.type == 0){
                ...
                for(let t = 0;t<1;t++){
                    ...
                    if(this.counter%1 == 0){
                        let toffset = Math.min(Math.max(0, this.x+(Math.round((Math.random()-.5)*2))), canvas.width)
                        let koffset = Math.min(Math.max(0, this.y+(Math.round((Math.random()-.5)*2))), canvas.width)
                        ...
                        if(toffset > canvas.width-1){
                            toffset = canvas.width-1
                        }
                        if(koffset > canvas.width-1){
                            koffset = canvas.width-1
                        }
                        this.attack(grid.blocks[toffset][koffset])
                    }
            }
    
                // canvas_context.fillRect(this.x, this.y, 1, 1)
            }
        }
    }
    ...
    class Grid{
        constructor(){
            ...
            for(let t = 0;t<canvas.width;t++){
                ...
                for(let k = 0;k<canvas.height;k++){
                    let agent = new Agent(t,k)
                    chunk.push(agent)

                    // if(Math.random()<.01){
                    //     agent.type = Math.floor(Math.random()*4)
                    // }
                }
        ...
        draw(){
            ...
            for(let t = canvas.width-1; t > 0;t--){
                for(let k = canvas.height-1; k > 0;k--){
                    this.blocks[t][k].draw()
                }
            }
            }
